"""Slow JSONL emitter for visually verifying the live dashboard modes.

Pipe into viz-tui to watch a synthetic benchmark progress in real time:

    python -m tests.live_demo race-2 | \
        .venv/bin/llama-benchy-viz-tui --mode live-race

    python -m tests.live_demo single | \
        .venv/bin/llama-benchy-viz-tui --mode live-single
